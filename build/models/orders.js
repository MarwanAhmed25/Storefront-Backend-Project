...
var Order = /** @class */ (function () {
    ...
    Order.prototype.index = function (id) {
    ...
    Order.prototype.update = function (o) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, q, id_of_user, user, sql, res, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 1:
                        conn = _a.sent();
                        q = 'select user_id from orders where id=($1)';
                        return [4 /*yield*/, conn.query(q, [o.id])];
                    case 2:
                        id_of_user = _a.sent();
                        user = id_of_user.rows[0];
